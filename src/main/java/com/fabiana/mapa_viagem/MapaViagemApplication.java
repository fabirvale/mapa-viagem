...
public class MapaViagemApplication {
    ...
    CommandLineRunner testViagem(ViagemRepository viagemRepository, VeiculoRepository veiculoRepository,
        ...
        return args -> {
            ...
            Viagem viagem1 = new Viagem(LocalDate.of(2026, 6, 30),"Pacientes para exames de sangue", "Santa Rita do Sapucai", "Santa Rita do Sapucaí","MG", "MG", LocalTime.of(13, 00), null, null);
            ...
            Agendamento agenda1 = new Agendamento(p1, a1, hospital1, viagem1, LocalDate.of(2026,6 , 30),LocalTime.of(14, 30));         	 
            Agendamento agenda2 = new Agendamento(p2, a2, hospital1, viagem2, LocalDate.now(),LocalTime.of(14, 30));
            Agendamento agenda3 = new Agendamento(p3, a2, hospital2, viagem3, LocalDate.of(2026, 6, 30),LocalTime.of(14, 30)); 
