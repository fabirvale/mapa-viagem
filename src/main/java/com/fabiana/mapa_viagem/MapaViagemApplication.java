...
public class MapaViagemApplication {
    ...
    CommandLineRunner testViagem(ViagemRepository viagemRepository, VeiculoRepository veiculoRepository,
    		...
    		AgendamentoRepository agendamentoRepository, TipoEspecialidadeRepository tipoEspecialidadeRepository, MotivoCancelamentoRepository motivoCancelamentoRepository) {
        return args -> {
            ...
            Viagem viagem1 = new Viagem(LocalDate.of(2026, 8, 30),"Pacientes para exames de sangue", "Santa Rita do Sapucaí", "Santa Rita do Sapucaí","MG", "MG", LocalTime.of(13, 00), null, null, StatusViagem.AGENDADA);
            Viagem viagem2 = new Viagem(LocalDate.of(2026, 8, 30), "Pacientes para exames de vista", "Santa Rita do Sapucaí", "Pouso Alegre", "MG", "MG",LocalTime.of(15, 30), m2, v2, StatusViagem.AGENDADA);
            Viagem viagem3 = new Viagem(LocalDate.of(2026, 8, 30),"Pacientes para exames", "Santa Rita do Sapucaí", "Pouso Alegre", "MG", "MG",LocalTime.of(15, 00), null, null, StatusViagem.AGENDADA);
            ...
            Agendamento agenda1 = new Agendamento(p1, a1, hospital1, tp, viagem1, LocalDate.of(2026,7 , 30),LocalTime.of(14, 30), TipoCompromisso.SUS, false, false, false, false, null, true, true, StatusAgendamento.AGENDADO);         	 
            Agendamento agenda2 = new Agendamento(p2, a2, hospital1, tp, viagem2, LocalDate.now(),LocalTime.of(14, 30), TipoCompromisso.SUS, false, false, false, false, null, true, true, StatusAgendamento.AGENDADO);
            Agendamento agenda3 = new Agendamento(p3, a2, hospital2, tp, viagem3, LocalDate.of(2026, 7, 30),LocalTime.of(16, 30), TipoCompromisso.SUS, false, false, false, false, null, true, true, StatusAgendamento.AGENDADO); 
